...
> Moved 2026-09-07 from yggdrasil (commit `8c96f1c`, branch `docs/forgejo-day2-design`, never merged) into the realm: the Forgejo cutover is SiliconSaga stack work, not GDD workspace tooling. Content is unchanged apart from link paths. It predates nidavellir's [2026-08-18 Forgejo cutover design](../../../../components/nidavellir/docs/plans/2026-08-18-forgejo-cutover-design.md), which contradicts it on mirror direction and phasing — a revision reconciling the two is pending.
