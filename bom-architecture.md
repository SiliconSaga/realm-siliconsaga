# Unified BOM Architecture (Parked Vision)

> **Parked 2026-06-05.** Moved from `yggdrasil/bom-architecture.md` during the realm docs reorganization. This vision predates GDD's current focus and is not currently being pursued; kept here for if/when CycloneDX-driven BOM tooling becomes interesting for the realm again. The project-constellation map this references was subsumed into `docs/stack.md` + `docs/stack-tier-*.md`.
