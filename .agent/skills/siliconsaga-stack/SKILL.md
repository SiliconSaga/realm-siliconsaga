...
| Terasology PR review procedure (merge-base diff, baseline, scoped run + XML verdict) | `terasology-review` | `realms/realm-siliconsaga/.agent/skills/` | always available |
