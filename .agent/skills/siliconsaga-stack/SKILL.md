...
| GDD methodology (orientation, housekeeping, review triage, scribe, writing-yggdrasil-docs) | `gdd-*`, `scribe`, `writing-yggdrasil-docs` | workspace-root `.agent/skills/` | always available |
